...
const query = refDebounced(search, 200)
      ...
      >
        ...
        >
          ...
          <div v-else class="grid grid-cols-4 gap-4 w-full">
            <div v-if="searchResults.topQuery.results.length > 0" class="flex flex-col space-y-2">
              <p>Top Results</p>
            ...
            <div v-if="searchResults.songs.results.length > 0" class="flex flex-col space-y-2">
              <p>Songs</p>
              <nuxt-link
            ...
            <div v-if="searchResults.albums.results.length > 0" class="flex flex-col space-y-2">
              <p>Albums</p>
              <nuxt-link
            ...
            <div v-if="searchResults.artists.results.length > 0" class="flex flex-col space-y-2">
              <p>Artists</p>
              <img
